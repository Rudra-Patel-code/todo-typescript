...
const DetailAndEditModal: React.FC<{
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    updateTodo(title, description, todo._id);
  ...
  return (
    <ModalContainer onClose={onClose}>
      <div
        ...
        className="relative border-[1px] bg-zinc-950 bg-opacity-95  border-white/75 flex flex-col items-center p-5 rounded-lg w-[95%] max-w-xl"
      >
        <div
          onClick={onClose}
        ...
        {isEditing ? (
          <form onSubmit={onSubmit} className="flex flex-col gap-4 w-full">
            ...
            <div className="mt-10 flex justify-around gap-4">
              ...
              <Button type="submit" className="w-[40%]" severity="primary">
                <MdEdit />
                Edit
              </Button>
            </div>
